...
import CitiesSkylinesIITheme from '@/components/chat/cities-skylines-ii/ThemeWrapper.vue';
...
:global(body[data-theme="windows-95"]) {
...
:global(body[data-theme="cities-skylines-ii"]) {
...
:global(body[data-theme="cities-skylines-ii"] .chat-view) {
  max-width: 565px;
}
</style>
